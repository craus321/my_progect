                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="inner-software-img software-img-shape">
                            <img src="{{ Voyager::image(setting('informaciia.imgs_info_31')) }}" alt="img" style="max-width: 100%; height: auto;">
                    ...
                    <div class="col-lg-6 pl-80">
                        <div class="slider-content mt-15">
                            ...
                            <p class="wow slideInLeft" data-wow-delay="0.4s">{!! (setting('glavnaia-stranica.home_4')) !!}</p>
