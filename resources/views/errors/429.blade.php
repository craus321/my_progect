                        ...
                        <div class="breadcrumb-wrap text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">429 Слишком много запросов</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 text-center">
                        ...
                        <div class="error-content">
                            ...
                            <p>Слишком много запросов. Пожалуйста, подождите некоторое время и повторите попытку.</p>
