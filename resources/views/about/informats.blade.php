                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="inner-software-img software-img-shape">
                            <img src="{{ Voyager::image(setting('o-nas.span_text_14_img')) }}" alt="img" style="max-width: 100%; height: auto;">
                    ...
                    <div class="col-lg-6 pl-80">
                        <div class="slider-content digital-slider-content mt-95">
                            <h2 class="wow fadeInUp" data-wow-delay="0.2s"><span> {{ setting('o-nas.span_text_13') }} </span>{{ setting('o-nas.span_text_14') }}</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">{!! setting('o-nas.span_text_15') !!}</p>
